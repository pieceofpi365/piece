    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("PieceOfPi version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  pieceofpid [options]                     " + "\n" +
                  "  pieceofpid [options] <command> [params]  " + _("Send command to -server or pieceofpid") + "\n" +
                  "  pieceofpid [options] help                " + _("List commands") + "\n" +
                  "  pieceofpid [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "pieceofpi:"))
                fCommandLine = true;
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: pieceofpi.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: pieceofpid.pid)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 3889 or testnet: 13889)") + "\n" +
