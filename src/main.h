...
static const int64 DUST_SOFT_LIMIT = 10000; // 0.0001 PIPI
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1;   // 0.00000001 PIPI mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 4357780 * COIN;
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 20571 / 250;
    }
