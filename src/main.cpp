...
uint256 hashGenesisBlock("0x509ff0c4aa02fadf4c50c7568b4482231412fa68b0602bea0f81cc48d34cbf2f");
...
{
    // PieceOfPi: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        pchMessageStart[2] = 0x2l;
        pchMessageStart[3] = 0x3d;
        hashGenesisBlock = uint256("0x56accf9a3129340b61027e6e58c2ddd043e0c31cf1cacb18396ecb5dcc211aa6");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1611782150;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084965535;

        if (fTestNet)
        {
            block.nTime    = 1611782152;
            block.nNonce   = 385483942;
        }
...
printf("block.GetHash = %s\n", block.GetHash().ToString().c_str());
        ...
        assert(block.hashMerkleRoot == uint256("0x505c5440bfbc4fbf6fdd3d6a7716c252e81190426c938d8d3a87706dc737e309"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xbe, 0xc0, 0xbl, 0xdd }; // PieceOfPi: increase each by adding 2 to bitcoin's value.
